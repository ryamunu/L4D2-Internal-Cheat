...
public:
  ...
  virtual bool SetFontGlyphSet(HFont hFont, const char *szFont, int nTall,
                               int nWeight, int nFlags, int nBlur,
                               int nScanlines, int unk1, int unk2) = 0;
  ...
  virtual void SetNotifyIcon(VPANEL context, int icon,
  ...
  virtual void DrawTexturedSubRect(int x0, int y0, int x1, int y1, float texs0,
                                   float text0, float texs1, float text1) = 0;
  virtual void DrawTexturedPolygon(int n, Vertex_t *pVertices,
                                   bool bClipVertices) = 0;
  ...
  virtual HCursor CreateCursorFromFile(char const *curOrAniFile,
...
private:
  virtual void DrawFilledRectFastFade(int unk1, int unk2, int unk3, int unk4,
                                      int unk5, int unk6, unsigned int alpha0,
                                      unsigned int alpha1,
                                      bool bHorizontal) = 0;
...
public:
  virtual void DrawFilledRectFade(int x0, int y0, int x1, int y1,
                                  ...
                                  bool bHorizontal) = 0;
  virtual void DrawSetTextureRGBAEx(int id, const unsigned char *rgba, int wide,
                                    int tall, int imageFormat) = 0;
  virtual void DrawSetTextScale(float sx, float sy) = 0;
  virtual bool SetBitmapFontGlyphSet(HFont font, const char *windowsFontName,
                                     float scalex, float scaley, int flags) = 0;
  ...
  virtual void
  DrawUnicodeString(const wchar_t *pwString,
                    FontDrawType_t drawType = FONT_DRAW_DEFAULT) = 0;
...
public:
  ...
  virtual void GetKernedCharWidth(HFont font, wchar_t ch, wchar_t chBefore,
                                  wchar_t chAfter, float &wide, float &abcA,
                                  float &abcC) = 0;
...
namespace I {
inline IVGuiSurface *VGuiSurface = nullptr;
}